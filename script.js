    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "משרד עורכי דין משה לבהר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '67ea0ca9-b6b4-4388-b73d-91f4b0e6e6a1',
                    name: data.name || '',
                    email: data.email || '',
